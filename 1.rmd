...
<img src="images/researchpipeline.png" width="85%" />
...
- we can write a text like:
    <small><pre><code>The coefficient of the speed variable is &#96;r b['speed']&#96; with the p-value of &#96;r p['speed']&#96;.</code></pre></small>
    
- which will be shown as:
    <small><pre><code>The coefficient of the speed variable is `r fmt(b['speed'])` with the p-value of `r fmt(p['speed'])`.</code></pre></small>
